...
/* $Id: nes_ppu.c,v 1.113 2001/03/16 18:49:21 nyef Exp $ */
...
void PPU_init(nes_rom romfile)
{
    ...
    video_setsize(256*DEFAULT_SCALER_NES, 240*DEFAULT_SCALER_NES);
...
/*
 * $Log: nes_ppu.c,v $
 * Revision 1.113  2001/03/16 18:49:21  nyef
 * updated to new mapper hsync interface
 *
