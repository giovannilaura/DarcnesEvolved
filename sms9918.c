...
/* $Id: sms9918.c,v 1.58 2001/03/14 23:58:43 nyef Exp $ */
...
void sms9918_init(sms9918 vdp, int is_gamegear)
{
    if (!is_gamegear) {
        //joe doubled
        video_setsize(DEFAULT_SCALER*256, DEFAULT_SCALER*192);
	
    } else {
	vdp->flags = TF_GAMEGEAR;
	video_setsize(DEFAULT_SCALER_GG*160, DEFAULT_SCALER_GG*144);
        //doubled;
        //video_setsize(320, 288);
        //tripled
        //video_setsize(480, 288+144);
    }
...
/*
 * $Log: sms9918.c,v $
 * Revision 1.58  2001/03/14 23:58:43  nyef
 * changed sprite renderer to draw from the tilecache
 *
