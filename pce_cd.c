...
//JoeFix
unsigned char pce_cd_180e;
unsigned char pce_cd_180f;
...
void pce_cd_command_0xd8(void)
{
    ...
    //JoeFix placed before nasty hack, allows pce cd to play thru mplayer
    printf("CD PLAY %d\n",pce_cd_command.args[2]);
...
void pce_cd_handle_command_final(void)
{
	...
	pce_cd_command_0xde();
    } else if (pce_cd_command.args[0] == 0x0a) {
	pce_cd_command_0x0a();
    } else {
	/* unknown command */
...
{
    //printf("PCE CD READ ($%04hx)\n",addr);
    if (!pce_cd_init) {
	pce_cd_initialize();
    }

    if (addr & 0x1e00 == 0x1a00) { //JoeFix Arcade Card 
            return pce_cd_1e00;
    }
...
#endif
 //JoeFix      
 }else if((addr & 0x18c0) == 0x18c0)
 {
  switch (addr & 0x18cf)
  {
   case 0x18c1: return 0xaa; break;
   case 0x18c2:	return 0x55; break;
   case 0x18c3: return 0x03; break;
   case 0x18c5:	return 0xaa; break;
   case 0x18c6: return 0x55; break;
   case 0x18c7:	return 0x03; break;
  }
...
/*  	    deb_printf("pce_cd: adpcm length set 0x%04hx.\n", pce_cd_adpcm_data16); */
	...
	if (data & 0x80) {
	    deb_printf("pce_cd: adpcm reset.\n");
            data=0x0; //JoeFix Does This Fix black Screen
	}
	pce_cd_180d = data;
