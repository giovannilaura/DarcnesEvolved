...
#define DEFAULT_SCALER 5
#define DEFAULT_SCALER_GG 6
#define DEFAULT_SCALER_NES 4
#define DEFAULT_SCALER_PCE 4
#define DEFAULT_SCALER_GENESIS 4
#define DEFAULT_SCALER_APPLE2 4
#define DEFAULT_SCALER_COLECO 5
#define DEFAULT_SCALER_MSX DEFAULT_SCALER_COLECO
