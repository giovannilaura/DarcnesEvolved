...
u8 a2_disk_read(struct a2_disk_card *card, u16 address)
{
    ...
    case 2: /* write byte */ /*JoeFix TRY TO WRITE*/
...
void a2_disk_load_disk(struct a2_disk_card *card,const char * fname,const char * fname2)
{
    rom_file romfile,romfile2;
...
/*      romfile = read_romimage("../roms/apple2/ProDOS.do"); */
    ...
    romfile2 = read_romimage(fname2);
    card->disks[1].disk_data = disk2_convert_disk(romfile2->data, disk2_do_translate_table);
...
struct apple2_card *apple2_disk_init(struct apple2_mainboard *apple2,char * fname,char * fname2)
{
