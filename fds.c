...
/* $Id: fds.c,v 1.7 2001/03/16 19:06:39 nyef Exp $ */
...
void map14_hsync(struct mapper_14 *mapper, int display_active)
{
...
void map14_load_bios(struct mapper_14 *mapper)
{
    ...
    printf("attempting to load FDS bios file.\n");
...
/*
 * $Log: fds.c,v $
 * Revision 1.7  2001/03/16 19:06:39  nyef
 * updated to use new hsync and irq interfaces
 *
